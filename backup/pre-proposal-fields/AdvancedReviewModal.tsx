...
export default function AdvancedReviewModal({
  ...
  const [aiFeedbackSuggestions] = useState([
    'This project demonstrates strong innovation in AI-powered code analysis with practical industry applications.',
    'The technical stack is modern and well-aligned with current software engineering trends.',
    'The methodology shows good understanding of NLP principles and their application in code review systems.',
  ]);
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
              ...
              <ul className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>Strong technical feasibility with modern stack</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Good industry relevance and practical applications</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-yellow-600 dark:text-yellow-400 mt-0.5 flex-shrink-0" />
                  <span>Moderate similarity detected - recommend adding unique features</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Innovative methodology with clear research components</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Suitable scope for final year project timeline</span>
                </li>
              </ul>
            </div>
          </div>
