    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {detailProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-auto border border-gray-200 dark:border-gray-700 p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">{detailProject.description}</p>
