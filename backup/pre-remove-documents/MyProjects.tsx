  ...
  const handleSaveEdit = async (e: React.FormEvent) => {
    ...
    try {
      await api.patch(`/projects/${editProject.id}`, {
        ...
        problem_statement: editForm.problemStatement || null,
        objectives: editForm.objectives || null,
        methodology: editForm.methodology || null,
        expected_outcomes: editForm.expectedOutcomes || null,
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-auto border border-gray-200 dark:border-gray-700">
            ...
            <form onSubmit={handleSaveEdit} className="p-6 space-y-4">
              ...
              <ProposalFormFields values={editForm} onChange={handleEditChange} />
