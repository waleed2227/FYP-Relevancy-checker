...
async def submit_project(
    ...
    methodology: str | None = Form(None),
    ...
    project = await project_service.create_project(
        ...
        description,
        professor_email,
        problem_statement=_optional_form(problem_statement),
        objectives=_optional_form(objectives),
        methodology=_optional_form(methodology),
        expected_outcomes=_optional_form(expected_outcomes),
        deliverables=_optional_form(deliverables),
    )
